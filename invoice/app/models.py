...
class seller(models.Model):
    name = models.CharField(max_length=50, default="ranauzair")
    address = models.CharField(max_length=150, default="hadalidistrictkhushab")
    phone = models.IntegerField(default='+923001234567')
